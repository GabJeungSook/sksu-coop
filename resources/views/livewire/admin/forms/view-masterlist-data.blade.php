<div>
    ...
    <div class="mt-3 overflow-hidden bg-gray-50 shadow sm:rounded-lg">
        <div class="border-t border-gray-100">
          <dl class=" divide-gray-100">
            <dt class="p-3 text-sm font-semibold text-gray-900 space-x-3">
                <span>Member ID:</span>
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                ...
                <div class="space-y-3">
                    ...
                    <x-input label="Full Name" disabled placeholder="your name" wire:model="full_name" />
                ...
                <x-input label="Address" disabled placeholder="---" wire:model="address" />
                <x-input label="Birthday" disabled placeholder="---" wire:model="birthday" />
                <x-input label="Age" disabled placeholder="---" wire:model="age" />
                <x-input label="TIN" disabled placeholder="---" wire:model="tin_number" />
                <x-input label="Gender" disabled placeholder="---" wire:model="gender" />
                <x-input label="Civil Status" disabled placeholder="---" wire:model="civil_status" />
                <x-input label="Religion" disabled placeholder="---" wire:model="religion" />
                <x-input label="Number of Dependent" disabled placeholder="---" wire:model="dependent_number" />
            </div>
      ...
      <div class="mt-3 overflow-hidden bg-gray-50 shadow sm:rounded-lg">
        <div class="border-t border-gray-100">
          <dl class="divide-y divide-gray-100">
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <div class="space-y-3">
                    <x-input label="Highest Educational Attainment" disabled placeholder="---" wire:model="educational_attainment" />
                ...
                <x-input label="Occupation" disabled placeholder="---" wire:model="occupation" />
                <x-input label="Annual Income" disabled placeholder="---" wire:model="income" />
            </div>
          </dl>
        </div>
      </div>
      ...
      <div class="mt-3 overflow-hidden bg-gray-50 shadow sm:rounded-lg">
        <div class="border-t border-gray-100">
          <dl class="divide-y divide-gray-100">
            <div class="px-4 py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                <div class="space-y-3">
                    <x-input label="Date Accepted" disabled placeholder="---" wire:model="date_accepted" />
                ...
                <x-input label="BOD Resolution Number" disabled placeholder="---" wire:model="bod_number" />
                <x-input label="Type / Kind of Membership" disabled placeholder="---" wire:model="membership_type" />
                <x-input label="Number of Shares Subscribed" disabled placeholder="---" wire:model="number_of_shares" />
                <x-input label="Amount Subscribed" disabled placeholder="---" wire:model="amount_subscribed" />
                <x-input label="Initial Paid Up" disabled placeholder="---" wire:model="initial_paid_up" />
            </div>
            {{-- <div class="px-4 py-6 sm:grid sm:grid-cols-5 sm:gap-4 sm:px-6">
      ...
      <div class="mt-3 overflow-hidden bg-gray-50 shadow sm:rounded-lg">
        <div class="border-t border-gray-100">
          <dl class="divide-y divide-gray-100">
            <div class="px-4 py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                <div class="space-y-3">
                    <x-input label="BOD Resolution" disabled placeholder="---" wire:model="bod_resolution" />
                ...
                <x-input label="Date" disabled placeholder="---" wire:model="date_created" />
            </div>
          </dl>
        </div>
      </div>
